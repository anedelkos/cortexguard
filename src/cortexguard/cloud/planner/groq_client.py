"""Groq-backed planner client for low-latency hosted inference experiments."""
...
class GroqLLMClient:
    def __init__(
        ...
        key = api_key or os.getenv("CLOUD_GROQ_API_KEY", "")
        raw_client = AsyncOpenAI(api_key=key, base_url=_GROQ_BASE_URL)
